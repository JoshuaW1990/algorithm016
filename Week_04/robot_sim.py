class Solution(object):
    def robotSim(self, commands, obstacles):
        ...
        last_directory = 0
        obstacle_set = set([(item[0], item[1]) for item in obstacles])
        result = 0
        for index, command in enumerate(commands):
            if command == -1:
                last_directory = (last_directory + 1 + 4) % 4
                continue
            if command == -2:
                last_directory = (last_directory - 1 + 4) % 4
                continue
...
# commands = [1,2,-2,5,-1,-2,-1,8,3,-1,9,4,-2,3,2,4,3,9,2,-1,-1,-2,1,3,-2,4,1,4,-1,1,9,-1,-2,5,-1,5,5,-2,6,6,7,7,2,8,9,-1,7,4,6,9,9,9]
commands = [1,2,-2,5,-1,-2,-1,8,3,-1,9,4,-2,3,2,4,3,9,2,-1,-1,-2,1,3,-2,4,1,4,-1,1,9,-1,-2,5,-1,5,5,-2,6,6,7,7,2,8,9,-1,7]
# commands = [1,2,-2,5,-1,-2,-1,8,3,-1,9,4,-2,3,2,4,3,9,2,-1,-1,-2,1,3,-2,4,1,4,-1,1,9,-1,-2,5,-1,5,5,-2,6,6,7,7,2,8,9]
